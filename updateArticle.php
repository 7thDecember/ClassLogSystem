                     ...
                     <table class="insert-tab" width="100%">
                         <tbody><tr>
                             ...
                             <tr>
                                 ...
                                 <td>
                                     <input class="common-text required" id="title" name="title" size="50" value='.$title.' type="text">
                                 </td>
                             </tr>
                             <tr>
                                 <th>文章内容：</th>
                                 <td><textarea name="content" class="common-textarea" id="content" name="content" cols="50" rows="20" style="width: 98%;">'.$context.'</textarea></td>
                             </tr>
                             <tr>
                                 <th></th>
                                 <td>
                                     <input class="btn btn-primary btn6 mr10" value="保存" name="fabu" type="submit">
...
';
 ...
 if(isset($_POST['fabu'])) {
  ...
  $tag=$_POST["tag"];
 	...
 	$date=date("Y-m-d");
  $loginSQL = "UPDATE article SET title='$title',tag='$tag',date='$date',context='$content' WHERE id='$id'";
   mysql_query($loginSQL);
   echo "<script>alert('已成功修改！')</script>";
