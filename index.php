...
<div id="wrapper">
	...
	<div id="menu">
		<ul>
		<li class="current_page_item"><a href="index.php">主页</a></li>
	...
	<div id="page-bgbtm">
		<div id="content">
			<div><img src="img/img02.jpg" alt="" width="658" height="377" /></div>
			';
			...
			while($row = mysql_fetch_array($result)){
				...
				echo	'<div class="entry">';
						$context=$row['context'];
						echo '<p>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp'.substr($context,0,600).'</p>';
						echo '<p class="links"><a href="#">阅读更多</a>&nbsp;&nbsp;&nbsp;&nbsp;</p>';
					echo	'</div>';
				echo	'</div>';
			}
		echo '
